...
class customer_analysis:
    ...
    def process(self):
        ...
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '1' and  visit>='1' and visit<='2'" % self.dealer_id
        self.cursor.execute(sql)
        dict['active_12'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '1' and  visit>='3' and visit<='4'" % self.dealer_id
        self.cursor.execute(sql)
        dict['active_34'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '1' and  visit >='5' " % self.dealer_id
        self.cursor.execute(sql)
        dict['active_5'] = self.cursor.rowcount
        dict['active'] = dict['active_12'] + dict['active_34'] + dict['active_5']
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '2' and  visit>='1' and visit<='2'" % self.dealer_id
        self.cursor.execute(sql)
        dict['less_12'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '2' and  visit>='3' and visit<='4'" % self.dealer_id
        self.cursor.execute(sql)
        dict['less_34'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '2' and  visit >='5' " % self.dealer_id
        self.cursor.execute(sql)
        
        dict['less_5'] = self.cursor.rowcount
        dict['lessactive'] = dict['less_12'] + dict['less_34'] + dict['less_5']
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '3' and  visit>='1' and visit<='2'" % self.dealer_id
        self.cursor.execute(sql)
        dict['lost_12'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '3' and  visit>='3' and visit<='4'" % self.dealer_id
        self.cursor.execute(sql)
        dict['lost_34'] = self.cursor.rowcount
        
        sql = "select * from funnel_customer where fdealer_id='%s' and status = '3' and  visit >='5' " % self.dealer_id
        self.cursor.execute(sql)
