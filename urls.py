...
from dealerfunnel.funnel.view.randomleadsetup import *
...
urlpatterns = patterns('',
    ...
    url(r'^ajax/',include('dealerfunnel.funnel.url.ajax')),
    url(r'^appointment/',include('dealerfunnel.funnel.url.appointment')),
    url(r'^$',landing().home,name='home'),
    # ==============================================================
    url(r'^dev/customer/',include('dealerfunnel.funnel.dev_url.customer')),
    #AJAX  =============
    url(r'^response/',include('dealerfunnel.funnel.url.response')),
    ...
    url(r'^randomlead/$',leadset,name='randomlead'),
